// lib/pages/support/chat_page.dart
...
import 'dart:io'; // Added missing import
...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> _saveMessageToFile(types.Message message) async {
    try {
      final documentsDir = await getApplicationDocumentsDirectory();
  ...
  void _showMessageContextMenu(types.Message message) {
    showMenu(
      context: context,
      ...
      if (value == 'delete') {
        ...
        _saveMessageToFile(types.TextMessage(
          author: _user,
          createdAt: DateTime.now().millisecondsSinceEpoch,
          id: const Uuid().v4(),
          text: '',
    ...
    return Scaffold(
      ...
      body: Chat(
        ...
        theme: const DefaultChatTheme(
          inputBackgroundColor: Color.fromARGB(255, 33, 33, 33),
        ...
        onMessageLongPress: (context, message) => _showMessageContextMenu(message),
      ),
    );
  }
}