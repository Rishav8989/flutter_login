                  ...
                  children: [
                    _buildFAQItem(
                      ...
                      content: [
                        ...
                        '1. Registration: Owners or distributors/installers can register their accounts on the login page of Rishav Web or App (Select the server site according to the actual situation, and be aware that the Chinese server only supports distributors/installers to register their accounts).',
                    ...
                    _buildFAQItem(
                      ...
                      content: [
                        'Access Rishav Web or App, click on "Forgot Password" on the login page to enter the "Account and Security" interface, and enter your account or email information to verify your identity. Reset the password after verification.',
                      ],
                    ),
                    _buildFAQItem(
                      context,
                      ...
                      content: [
                        'Enter your account and password to log in Rishav Web or App, click "Account and Security -> Account Password" to enter corresponding interface, and you can reset the password.',
                      ],
                    ),
                    _buildFAQItem(
                      context,
